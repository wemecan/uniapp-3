<template>
    <view class="priceRegistrationPages">
        <qm-navbar :event="goBack" title="定价登记"></qm-navbar>
            ...
            <view class="registration-list">
                ...
                <view class="registration-item">
                    ...
                    <view class="item-right">
                        <picker mode="date" class="item-input" v-model="formData.pricingTime" @change="bindStartDateChange">
                ...
                <view class="registration-item">
                    ...
                    <view class="item-right">
                        <input type="number" placeholder="请输入价格" v-model="formData.price" />
                    </view>
                </view>
                <!-- 商品信息 -->
                <view class="registration-item">
...
export default {
    ...
    methods: {
        bindStartDateChange(e) {
            this.formData.pricingTime = e.target.value
        },
        // 添加
        addList() {
        ...
        async doSave() {
            let toastFlag = true
            if (this.formData.pricingTime.length <= 0) {
                uni.showToast({
                    icon: 'none',
                    title: '定价日期不能为空'
                })
